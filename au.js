...
class Client {
    ...
    loadGUI() {
        ...
        <input onchange="localStorage.setItem('botNick', this.value);" id="botNick" maxlength="15" class="form-control" placeholder="Bot Name" value="NOO"></input>
        <input onchange="localStorage.setItem('botAmount', this.value);" id="BotAmount" maxlength="3" class="form-control" placeholder="Bot Amount" value="27"></input>
    ...
    startBots(amount) {
        ...
        amount > 160 ? amount = 160 : amount = amount;
